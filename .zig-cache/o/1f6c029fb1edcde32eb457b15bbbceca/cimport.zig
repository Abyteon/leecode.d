...
pub const struct_libdeflate_options = extern struct {
    sizeof_options: usize = @import("std").mem.zeroes(usize),
...
pub extern fn libdeflate_alloc_compressor_ex(compression_level: c_int, options: [*c]const struct_libdeflate_options) ?*struct_libdeflate_compressor;
pub extern fn libdeflate_deflate_compress(compressor: ?*struct_libdeflate_compressor, in: ?*const anyopaque, in_nbytes: usize, out: ?*anyopaque, out_nbytes_avail: usize) usize;
pub extern fn libdeflate_deflate_compress_bound(compressor: ?*struct_libdeflate_compressor, in_nbytes: usize) usize;
pub extern fn libdeflate_zlib_compress(compressor: ?*struct_libdeflate_compressor, in: ?*const anyopaque, in_nbytes: usize, out: ?*anyopaque, out_nbytes_avail: usize) usize;
pub extern fn libdeflate_zlib_compress_bound(compressor: ?*struct_libdeflate_compressor, in_nbytes: usize) usize;
pub extern fn libdeflate_gzip_compress(compressor: ?*struct_libdeflate_compressor, in: ?*const anyopaque, in_nbytes: usize, out: ?*anyopaque, out_nbytes_avail: usize) usize;
...
pub extern fn libdeflate_alloc_decompressor_ex(options: [*c]const struct_libdeflate_options) ?*struct_libdeflate_decompressor;
pub const LIBDEFLATE_SUCCESS: c_int = 0;
pub const LIBDEFLATE_BAD_DATA: c_int = 1;
pub const LIBDEFLATE_SHORT_OUTPUT: c_int = 2;
pub const LIBDEFLATE_INSUFFICIENT_SPACE: c_int = 3;
pub const enum_libdeflate_result = c_uint;
pub extern fn libdeflate_deflate_decompress(decompressor: ?*struct_libdeflate_decompressor, in: ?*const anyopaque, in_nbytes: usize, out: ?*anyopaque, out_nbytes_avail: usize, actual_out_nbytes_ret: [*c]usize) enum_libdeflate_result;
pub extern fn libdeflate_deflate_decompress_ex(decompressor: ?*struct_libdeflate_decompressor, in: ?*const anyopaque, in_nbytes: usize, out: ?*anyopaque, out_nbytes_avail: usize, actual_in_nbytes_ret: [*c]usize, actual_out_nbytes_ret: [*c]usize) enum_libdeflate_result;
pub extern fn libdeflate_zlib_decompress(decompressor: ?*struct_libdeflate_decompressor, in: ?*const anyopaque, in_nbytes: usize, out: ?*anyopaque, out_nbytes_avail: usize, actual_out_nbytes_ret: [*c]usize) enum_libdeflate_result;
pub extern fn libdeflate_zlib_decompress_ex(decompressor: ?*struct_libdeflate_decompressor, in: ?*const anyopaque, in_nbytes: usize, out: ?*anyopaque, out_nbytes_avail: usize, actual_in_nbytes_ret: [*c]usize, actual_out_nbytes_ret: [*c]usize) enum_libdeflate_result;
pub extern fn libdeflate_gzip_decompress(decompressor: ?*struct_libdeflate_decompressor, in: ?*const anyopaque, in_nbytes: usize, out: ?*anyopaque, out_nbytes_avail: usize, actual_out_nbytes_ret: [*c]usize) enum_libdeflate_result;
pub extern fn libdeflate_gzip_decompress_ex(decompressor: ?*struct_libdeflate_decompressor, in: ?*const anyopaque, in_nbytes: usize, out: ?*anyopaque, out_nbytes_avail: usize, actual_in_nbytes_ret: [*c]usize, actual_out_nbytes_ret: [*c]usize) enum_libdeflate_result;
...
// /Users/bai.tn/.zvm/master/lib/include/__stddef_offsetof.h:16:9
...
pub const LIBDEFLATE_VERSION_MAJOR = @as(c_int, 1);
pub const LIBDEFLATE_VERSION_MINOR = @as(c_int, 24);
pub const LIBDEFLATE_VERSION_STRING = "1.24";
pub const LIBDEFLATEAPI = "";
...
pub const libdeflate_compressor = struct_libdeflate_compressor;
pub const libdeflate_options = struct_libdeflate_options;
pub const libdeflate_decompressor = struct_libdeflate_decompressor;
pub const libdeflate_result = enum_libdeflate_result;
